...
<script src="hotel/js/modernizr.custom.js"></script>
...
<!-- header -->
	<div class="banner">
		<div class="container">
				...
				<!-- script-for-nav -->
				<div class="logo">
					<a href="index.html"><img src="hotel/images/logo.png" class="img-responsive" alt="" /></a>
				</div>
...
<!-- ENCHANTMENT  -->
	<div class="ENCHANTMENT" id="ourresort">
			<div class="col-md-6 ENCHANTMENT-left">
				<img src="hotel/images/5.jpg" class="img-responsive" alt="">
			</div>
							...
							<ul class="slides">
								<li>
									<div class="slider-info">
										<img src="hotel/images/logo1.png" class="img-responsive" alt="">
...
<!-- wonder -->
	<div class="wonder" id="">
		<div class="col-md-2 wonder-left">
			<img src="hotel/images/2.jpg" class="img-responsive" alt="">
		</div>
		...
		<div class="col-md-6 wonder-right">
			<img src="hotel/images/bed2.jpg" class="img-responsive" alt="">
		</div>
			<div class="clearfix"> </div>
	</div>
<!-- wonder -->
<!-- rooms -->
	<div class="rooms" id="suites">
		<div class="col-md-4 rooms-1">
			<div class="room-info">
				<img src="hotel/images/logo2.png" class="img-responsive" alt="">
			</div>
		...
		<div class="col-md-4 rooms-2">
			<div class="room-info">
				<img src="hotel/images/logo3.png" class="img-responsive" alt="">
			</div>
			<div class="room-info1">
					<ul>
						<li><a href="#"><i class="search"></i>explore</a></li>
		...
		<div class="col-md-4 rooms-3">
			<div class="room-info">
				<img src="hotel/images/logo4.png" class="img-responsive" alt="">
			</div>
			<div class="room-info1">
					<ul>
						<li><a href="#"><i class="search"></i>explore</a></li>
...
Specific menus and food </p>
		...
		<div class="col-md-6 services-right">
			<img src="hotel/images/3.jpg" class="img-responsive" alt="">
		</div>
			<div class="clearfix"> </div>
	</div>
<!-- services -->
	...
	<div class="contact" id="reservations">
		<div class="col-md-4 contact-left">
			<div class="contact-left1">
				<img src="hotel/images/logo5.png" class="img-responsive" alt="">
				<h3>RESERVATION</h3>
			</div>
		</div>
...
<!-- footer -->
	<div class="footer">
		...
		<img src="hotel/images/4.jpg" class="img-responsive" alt="">
		...
		<div class="col-md-6 footer-right">
			...
			<div class="col-md-6 footer-right1">
				<img src="hotel/images/fo.png" class="img-responsive" alt="">
			</div>
			<div class="col-md-6 footer-right2">
				<img src="hotel/images/un.png" class="img-responsive" alt="">
			</div>
				<div class="clearfix"> </div>
