  ...
  <body>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="images/11.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="images/12.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>FLIGHTS.</h1>
    ...
    <div class="container marketing">
      ...
      <!-- ================================================================== -->
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="img-rectangle" src="images/banner1.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>HOTELS</h2>
            ...
            <p><a class="btn btn-default" href="http://localhost/appppp/index.html" role="button">View details &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="img-rectangle" src="images/12.jpg" alt="Generic placeholder image" width="140" height="140">
            <h2>FLIGHTS</h2>
            <p>Enjoy the stupendous calm and peace of this tree-shaded location cradled by mountains where time stands still.choose ease, harmony and wellbeing over the hectic pace of today's lifestyle!</p>
            <p><a class="btn btn-default" href="http://localhost/img/index.html" role="button">View details &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="img-rectangle" src="images/11.jpg"alt="Generic placeholder image" width="140" height="140">
            <h2>TOURS</h2>
            <p>Enjoy the stupendous calm and peace of this tree-shaded location cradled by mountains where time stands still.choose ease, harmony and wellbeing over the hectic pace of today's lifestyle!.</p>
            <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
